...
var publishCommentButton = document.getElementById("publish-commentbtn");
...
writeCommentsButton.addEventListener("click", function () {
    console.log("writeComments()");
    writeComments();
    writeCommentsButton.innerHTML = "Comments Written! 😎"
}, false);

publishCommentButton.addEventListener("click", function () {
    console.log("publishComment()");
    publishComment();
    publishCommentButton.innerHTML = "Comments Publishing! 😎"
}, false);

loadMoreCommentsButton.addEventListener("click", function () {
    console.log("loadMoreComments()");
    loadMoreComments();
    loadMoreCommentsButton.innerHTML = "Comments loaded! 😎"
}, false);
